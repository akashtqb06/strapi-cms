...
var ProtectedHistoryPage = (0, import_react.lazy)(
  () => import("./History-DRwA3oMM-TIFX5GOR.js").then((mod) => ({ default: mod.ProtectedHistoryPage }))
);
var routes$1 = [
  {
...
var ProtectedEditViewPage = (0, import_react.lazy)(
  () => import("./EditViewPage-B82x_x1b-6T2EG7PR.js").then((mod) => ({ default: mod.ProtectedEditViewPage }))
);
var ProtectedListViewPage = (0, import_react.lazy)(
  () => import("./ListViewPage-CELx2ysp-SZAK3P6H.js").then((mod) => ({ default: mod.ProtectedListViewPage }))
);
var ProtectedListConfiguration = (0, import_react.lazy)(
  () => import("./ListConfigurationPage-BxfQJzPk-EBILNWKC.js").then((mod) => ({
    default: mod.ProtectedListConfiguration
  }))
);
var ProtectedEditConfigurationPage = (0, import_react.lazy)(
  () => import("./EditConfigurationPage-DdPNAbl3-X77GVRDE.js").then((mod) => ({
    default: mod.ProtectedEditConfigurationPage
  }))
);
var ProtectedComponentConfigurationPage = (0, import_react.lazy)(
  () => import("./ComponentConfigurationPage-DfFSZQxe-IWLIHPB2.js").then((mod) => ({
    default: mod.ProtectedComponentConfigurationPage
  }))
);
var NoPermissions = (0, import_react.lazy)(
  () => import("./NoPermissionsPage-DWleVYK7-N6LHLK6G.js").then((mod) => ({ default: mod.NoPermissions }))
);
var NoContentType = (0, import_react.lazy)(
  () => import("./NoContentTypePage-DtJ9jcfk-5YWBEC66.js").then((mod) => ({ default: mod.NoContentType }))
);
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-2CfjL0T9-JXWYGWQF.js");
        return {
          Component: Layout
        };
      },
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/ar.json": () => import("./ar-CCEVvqGG-DIBIOV6U.js"), "./translations/ca.json": () => import("./ca-5U32ON2v-7EAB2GYE.js"), "./translations/cs.json": () => import("./cs-CM2aBUar-6QAC7LTM.js"), "./translations/de.json": () => import("./de-C72KDNOl-G4RCMT23.js"), "./translations/en.json": () => import("./en-DKV44jRb-XPTUNI3Y.js"), "./translations/es.json": () => import("./es-CeXiYflN-3SHONMAT.js"), "./translations/eu.json": () => import("./eu-CdALomew-4OFWLLC7.js"), "./translations/fr.json": () => import("./fr-CD9VFbPM-3J3B2NGS.js"), "./translations/gu.json": () => import("./gu-CNpaMDpH-7XMLGNB6.js"), "./translations/hi.json": () => import("./hi-Dwvd04m3-TZSWOFL5.js"), "./translations/hu.json": () => import("./hu-CeYvaaO0-PBENROZ5.js"), "./translations/id.json": () => import("./id-BtwA9WJT-PXQ7HQUS.js"), "./translations/it.json": () => import("./it-BrVPqaf1-N2STEVHW.js"), "./translations/ja.json": () => import("./ja-CtsUxOvk-GAM7SGQJ.js"), "./translations/ko.json": () => import("./ko-HVQRlfUI-PW4M22WU.js"), "./translations/ml.json": () => import("./ml-BihZwQit-ZHUIH6DN.js"), "./translations/ms.json": () => import("./ms-m_WjyWx7-V4KDEFKU.js"), "./translations/nl.json": () => import("./nl-D4R9gHx5-ODJ6B7NO.js"), "./translations/pl.json": () => import("./pl-sbx9mSt_-DTBYNI57.js"), "./translations/pt-BR.json": () => import("./pt-BR-C71iDxnh-J6SAO6E7.js"), "./translations/pt.json": () => import("./pt-BsaFvS8--AYFTSKTU.js"), "./translations/ru.json": () => import("./ru-BE6A4Exp-727CWDPB.js"), "./translations/sa.json": () => import("./sa-Dag0k-Z8-IGCOAC65.js"), "./translations/sk.json": () => import("./sk-BFg-R8qJ-YBQFMQBE.js"), "./translations/sv.json": () => import("./sv-CUnfWGsh-NQO5EVRU.js"), "./translations/th.json": () => import("./th-BqbI8lIT-SOGSAPR3.js"), "./translations/tr.json": () => import("./tr-CgeK3wJM-ZOCTFXY2.js"), "./translations/uk.json": () => import("./uk-CR-zDhAY-R4NJEAR3.js"), "./translations/vi.json": () => import("./vi-DUXIk_fw-UXOGD5TG.js"), "./translations/zh-Hans.json": () => import("./zh-Hans-BPQcRIyH-KV7IQIPG.js"), "./translations/zh.json": () => import("./zh-BWZspA60-4CWFLKHW.js") }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=chunk-T3GMVIAF.js.map
